...
tablename = 'numerosnaturales100';

disp('Operacion de los primeros 100 numeros naturales')
...
texto1 = sprintf('El la suma de cuadrados de los primeros 100 numeros naturales es \n %s = %d',sumadecuadrados_str,sumadecuadrados_int);
disp(texto1)
texto2 = sprintf('El cuadrado de la suma de los primeros 100 numeros naturales es \n (%s)^2 = %d',cuadradodesumas_str,cuadradodesumas_int);
disp(texto2)
texto3 = sprintf('Por lo tanto la diferencia entre la suma de los cuadrado\nde los primeros 100 numeros y el cuadrado de la suma es\n%d',cuadradodesumas_int-sumadecuadrados_int);
disp(texto3)
